  ...
  return (
    <>
      <div className="header">
        <img src="/kiit-logo.png" alt="KIIT Logo" className="logo" />
      ...
      <div className="app-container">
        <div className="main-box">
          <div className="tab-bar">
            ...
            <button className={`tab-button ${activeTab === 'report' ? 'active' : ''}`} onClick={() => setActiveTab('report')}>
              Report
            </button>
            <button className={`tab-button ${activeTab === 'setting' ? 'active' : ''}`} onClick={() => setActiveTab('setting')}>
              Setting
            </button>
          </div>
